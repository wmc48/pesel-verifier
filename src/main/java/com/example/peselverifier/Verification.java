...
public class Verification extends PeselInfo {
    ...
    public boolean verByPattern(StringBuilder peselNumber) {
        ...
        int dayOfBirth = Character.getNumericValue(peselNumber.charAt(4)) * 10 + Character.getNumericValue(peselNumber.charAt(4));
